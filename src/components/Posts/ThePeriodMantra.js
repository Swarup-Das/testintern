...
import ThePeriodMantraImage from "../../images/ThePeriodMantra.png";

const ThePeriodMantra = () => {
      ...
      <Card className={classes.card} raised elevation={6}>
        <ButtonBase className={classes.cardAction}>
          <CardMedia
            ...
            image={ThePeriodMantraImage}
            title="ThePeriodMantra"
          ></CardMedia>
...
export default ThePeriodMantra;
